...
function BuiltInFunctorProvider(findUnifications) {
  ...
  let checkOrSetOutputArg = function checkOrSetOutputArg(value, outputArg) {
    ...
    if (value.evaluate() === output.evaluate()) {
      result.push(
        {
          theta: {}
        }
  ...
  let functors = {
    ...
    'append/2': function (v1Arg, v2Arg) {
      ...
      if (v1 instanceof Array) {
        v1.forEach((instance) => {
          result = result.concat(functors['append/2'](instance, v2Arg));
        });
        return result;
      }
    ...
    'append/3': function (v1Arg, v2Arg, v3Arg) {
      ...
      if (v1 instanceof Array) {
        v1.forEach((instance) => {
          result = result.concat(functors['append/3'](instance, v2Arg, v3Arg));
        });
        return result;
      }
    ...
    'length/1': function (v1Arg) {
      ...
      if (v1 instanceof Array) {
        v1.forEach((instance) => {
          result = result.concat(functors['length/1'](instance));
        });
        return result;
      }
    ...
    'length/2': function (v1Arg, v2Arg) {
      ...
      if (v1 instanceof Array) {
        v1.forEach((instance) => {
          result = result.concat(functors['length/2'](instance, v2Arg));
        });
        return result;
      }
